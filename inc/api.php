...
function upload_image(WP_REST_Request $request) {
    ...
    if (!check_ajax_referer('wp_rest', '_wpnonce', false)) {
        $output = array('status' => 403,
            ...
            'link' => "https://cdn.jsdmirror.com/npm/sakurairo_vision@2.6/basic/step04.md.png",
            'proxy' => iro_opt('comment_image_proxy') . "https://cdn.jsdmirror.com/npm/sakurairo_vision@2.6/basic/step04.md.png",
        );
