...
?>
			...
			<div class="footer-device function_area">
					...
					<span style="color: #b9b9b9;">
						...
						<?php if (iro_opt('footer_upyun', 'true')): ?>
							本网站由 <a href="https://www.upyun.com/?utm_source=lianmeng&utm_medium=referral" target="_blank"> <img alt="upyun-logo" src="https://cdn.jsdmirror.com/npm/sakurairo_vision@2.6/options/upyun_logo.webp"  style="display:inline-block;vertical-align:middle;width:60px;height:30px;"/> 提供 CDN 加速 / 云存储 服务
                        <?php endif; ?>
                        <br>
	...
	<div id="mo-nav">
		<div class="m-avatar">
			...
			$ava = iro_opt('personal_avatar') ? $personal_avatar: ($iro_logo ?: iro_opt('vision_resource_basepath','https://cdn.jsdmirror.com/npm/sakurairo_vision@2.6/').'series/avatar.webp'); ?>
